        ...
        <div className='rounded-2xl border border-border bg-card shadow-xl p-8 space-y-6'>
          ...
          <div className='flex flex-col items-center gap-3'>
            ...
            <div className='text-center'>
              <h1 className='text-xl font-bold font-display tracking-tight'>{SITE_CONFIG.login}</h1>
          ...
          <p className='text-center text-xs text-muted-foreground'>Use any email + 8+ char password to demo login.</p>
        </div>
      </div>
    </div>
  );
