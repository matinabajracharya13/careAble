                      ...
                      return (
                        ...
                        >
                          ...
                          <td className='px-4 py-4'>
                            <span
                              className={`inline-flex items-center gap-1 text-xs font-medium px-2 py-1 rounded-md ${ROLE_COLORS[user?.role_name as unknown as UserRole]}`}
                            >
                              {user.role_name === 'admin' && <UserCheck className='h-3 w-3' />}
                              {user.role_name}
                            </span>
                          </td>
                          <td className='px-4 py-4'>
                            <Badge
                              variant={STATUS_VARIANT[user.is_active ? 'active' : 'inactive']}
