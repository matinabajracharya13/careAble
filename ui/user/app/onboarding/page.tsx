...
import { ChevronLeft, ChevronRight, CheckCircle, Loader2, Briefcase, Zap, Target, Users, Building2 } from 'lucide-react';
    ...
    <div className='min-h-screen bg-background relative overflow-hidden pt-20 pb-10'>
      ...
      <div className='container max-w-2xl mx-auto px-4 relative z-10'>
        ...
        <div className='mb-8 text-center space-y-2 animate-fade-in'>
          ...
          <p className='text-muted-foreground text-sm'>Help us personalise your experience. This takes about 3 minutes.</p>
        </div>
            ...
            {categories.map((cat, i) => (
              <div
                ...
                className={cn(
                  ...
                  i <= currentCategoryIndex ? 'text-primary' : 'text-muted-foreground/50'
                )}
              >
        ...
        <p className='text-center text-xs text-muted-foreground mt-6'>You can update these details anytime from your profile settings.</p>
      </div>
    </div>
  );
}
